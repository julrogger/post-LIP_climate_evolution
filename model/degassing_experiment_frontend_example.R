...
parLapply(cl = cl, pars_list, fun = function(df_entry){
  ...
  CO2_ppm_start <- 600 # This sets the starting CO2 conentration for the model experiment
  ...
  degass_mass <- 40000e+15 # Set the amount of C degassing during the LIP Period, this should be given in grams
