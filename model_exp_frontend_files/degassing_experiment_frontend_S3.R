...
parLapply(cl = cl, pars_list, fun = function(df_entry){
  ...
  t <- -250e+6 # This sets the geologic time period and paleogeography considered, current options are: -250e+6 for the Permian-Triassic, -200e+6 for the Triassic Jurassic, -55e+6 for the Paleocene-Eocene, 0 for the present day configuration
  degass_mass <- 50000e+15 # Set the amount of C degassing during the LIP Period, this should be given in grams
