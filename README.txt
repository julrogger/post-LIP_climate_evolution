This repository includes all files needed to reproduce the climate trajectories from the paper 'Bio-geographic climate sensitivity controls Earth system response to Large Igneous Province carbon degassing' by Rogger et al.
